...
export const TIPS = {
  ...
  finality: "Every validated transaction this deal produced on XRPL testnet, in ledger order: escrow creates, finishes, cancels and the verifier's x402 payment. Each hash opens in the explorer.",
  negotiateLocked: "Lock the escrow ladder first. Agents only negotiate money that is already on the ledger.",
